...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        {/* Google Analytics */}
        <Script src="https://www.googletagmanager.com/gtag/js?id=G-7MP8MDK7Q0" strategy="afterInteractive" />
        <Script id="google-analytics" strategy="afterInteractive">
          {`
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());
          gtag('config', 'G-7MP8MDK7Q0');
        `}
        </Script>
      </head>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Access authentic hadiths from major collections through our simple API or browse them
                          directly.
                        </p>
                      </div>
                      <div>
