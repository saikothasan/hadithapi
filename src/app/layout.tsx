            ...
            <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
              <div className="container mx-auto flex h-16 items-center px-4">
                ...
                <nav className="hidden md:flex ml-10 gap-6">
                  <Link href="/collection/bukhari" className="text-sm font-medium hover:text-primary transition-colors">
                    Bukhari
                  </Link>
                  <Link href="/collection/muslim" className="text-sm font-medium hover:text-primary transition-colors">
                    Muslim
                  </Link>
                  <Link
                ...
                <div className="ml-auto flex items-center gap-2">
                  ...
                  <div className="hidden md:flex items-center gap-2">
                    <Button variant="outline" size="icon" asChild>
                      <Link href="https://github.com/yourusername/hadith-api" target="_blank" rel="noopener noreferrer">
